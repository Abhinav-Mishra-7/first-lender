...
const HeroBusinessOverdraftLoan = () => {
  return (
    <section className="w-full bg-gradient-to-r from-[#f8df8e] via-[#fdfada] to-yellow-100 mt-22 md:mt-25.5 mb-0">
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-8 md:py-7 lg:py-7 mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* LEFT CONTENT - Business Overdraft Specific */}
          <div className="space-y-4 md:space-y-4 lg:space-y-5">
            ...
            <p className="mt-2 text-slate-700 text-base md:text-sm max-w-xl">
              Flexible overdraft facility against your business current account. Withdraw more than your balance anytime and pay interest <span className="font-bold text-yellow-600">only on used amount</span> with instant activation and no prepayment penalty.
            </p>

            {/* BUSINESS OVERDRAFT FEATURES */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Feature text="Interest on Used Amount Only" />
              <Feature text="No Prepayment Penalty" />
              <Feature text="Instant Activation" />
              <Feature text="Flexible Limit Enhancement" />
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-white rounded-4xl border-x-4 border-yellow-400 shadow-xl p-6 md:p-4">
              ...
              <h3 className="text-base font-medium text-slate-900 text-center">
                Check Low Cost
                <span className="text-yellow-500"> Overdraft Loan </span>
                Offers
              </h3>
              ...
              <div className="flex justify-center items-center">
                ...
                <p className="text-xs text-slate-600 text-center leading-relaxed mt-4 ml-1">
                    ...
                    <p>Conditions and <span className="text-blue-700 cursor-pointer"> Credit Score Policy <span className="text-black">.</span></span></p>
                </p>
              </div>
            </div>
          </div>
...
export default HeroBusinessOverdraftLoan;

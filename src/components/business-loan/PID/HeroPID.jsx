        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-4 md:space-y-4 lg:space-y-5">
            ...
            <p className="mt-2 text-slate-700 text-base md:text-sm max-w-xl">
              Unlock instant cash from your purchase invoices. Get up to <span className="font-bold text-yellow-600">90%</span> funding against invoices within 24 hours with no collateral and flexible repayment terms.
            </p>

            {/* PID FEATURES */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Feature text="Up to 90% Invoice Value" />
              <Feature text="No Collateral Required" />
              <Feature text="Funding in 24 Hours" />
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-white rounded-4xl border-x-4 border-yellow-400 shadow-xl p-6 md:p-4">
              ...
              <h3 className="text-base font-medium text-slate-900 text-center">
                Check Low Cost
                <span className="text-yellow-500"> PID Offers </span>
                Now
              </h3>

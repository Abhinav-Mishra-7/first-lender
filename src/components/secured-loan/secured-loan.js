...
const secured = [
    {
        ...
        p1: "Are you planning to buy a new Home? You are at the right place. With our expertise in secured market we can offer you a wide variety of home loan which can fulfill your needs at one of the lowest interest rates available. We cater to all type customer base like Salaried, Self Employed, Professional, NRIs etc." ,
        p2: `Our team of experienced secured lending specialists offers a comprehensive range of diverse home loan products and solutions, meticulously designed to perfectly align with your unique financial requirements, all available at some of the most ultra-competitive and attractive interest rates currently prevailing in the market.`,
        p3: "The rate of interest on Home Loans starts from 7.15% subject to the Credit Cibil Score and Loan Amount. With Simple Documentation and Quick Sanction we are here to help you buy your Dream Home.",
        image: home
    },
    {
        name: "Car Loan" ,
        heading: "What is a Car Loan?" ,
        p1: "A car loan is a financial agreement that allows you to borrow money to purchase a vehicle, which you repay over time with interest." ,

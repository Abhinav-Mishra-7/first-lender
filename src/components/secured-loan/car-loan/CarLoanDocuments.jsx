...
function CarLoanDocuments({ loanType = "Car" }) {
  return (
      ...
      >
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 pb-4 text-shadow-md">
            Documents Required for a Quick <span className="capitalize">{loanType}</span> Loan
          </h2>
          ...
          <ul className="text-slate-600 text-sm leading-relaxed space-y-2 list-disc pl-5">
            ...
            <li>
              <span className="font-medium text-slate-800">PAN Card</span>
            </li>
            <li>
              <span className="font-medium text-slate-800">Employee ID Card</span>
            </li>
            <li>
              <span className="font-medium text-slate-800">Salary Slips:</span> Latest three months salary slips (for salaried employees)
            </li>
            <li>
              <span className="font-medium text-slate-800">Bank Statements:</span> Last six months bank statement
            </li>
          </ul>
        </div>
...
export default CarLoanDocuments;
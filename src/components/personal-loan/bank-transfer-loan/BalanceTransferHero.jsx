        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-4 md:space-y-4 lg:space-y-5">
            ...
            <p className="mt-2 text-slate-700 text-base md:text-sm max-w-xl">
              Get instant money transferred to your bank account within minutes. Fast, secure bank transfers for urgent cash needs with zero hassle from <span className="text-yellow-600 font-semibold">FIRSTLENDER</span>.
            </p>

            {/* FEATURES */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Feature text="Money in Minutes" />
              <Feature text="Direct Bank Transfer" />
              <Feature text="Zero Processing Fee" />
              <Feature text="24/7 Availability" />
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-white rounded-4xl border-x-4 border-yellow-400 shadow-xl p-6 md:p-4">
              ...
              <h3 className="text-base font-medium text-slate-900 text-center">
                Get Instant
                <span className="text-yellow-500"> Balance Transfer </span>
                Now
              </h3>
...
export default HeroBalanceTransfer;
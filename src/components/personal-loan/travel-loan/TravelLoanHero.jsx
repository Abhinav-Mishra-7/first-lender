        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-4 md:space-y-4 lg:space-y-5">
            ...
            <p className="mt-2 text-slate-700 text-base md:text-sm max-w-xl">
              Plan your dream vacation without financial stress. Get instant travel loans for flights, hotels, holidays, and international trips with flexible repayment and attractive rates from <span className="text-yellow-600 font-semibold">FIRSTLENDER</span>.
            </p>

            {/* FEATURES */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Feature text="Domestic & International Travel" />
              <Feature text="No Collateral Required" />
              <Feature text="Instant Approval" />
              <Feature text="Flexible Tenures" />
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md bg-white rounded-4xl border-x-4 border-yellow-400 shadow-xl p-6 md:p-4">
              ...
              <h3 className="text-base font-medium text-slate-900 text-center">
                Check Low Interest
                <span className="text-yellow-500"> Travel Loan </span>
                Offers
              </h3>

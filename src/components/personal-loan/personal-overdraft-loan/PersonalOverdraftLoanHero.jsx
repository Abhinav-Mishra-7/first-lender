...
const HeroPersonalOverdraftLoan = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-4 md:space-y-4 lg:space-y-5">
            ...
            <p className="mt-2 text-slate-700 text-base md:text-sm max-w-xl">
              Get flexible overdraft facility against your savings/current account. Withdraw more than your balance anytime with interest only on the amount used. Perfect solution for emergency cash needs with <span className="text-yellow-600 font-semibold">FIRSTLENDER</span>.
            </p>
...
export default HeroPersonalOverdraftLoan;